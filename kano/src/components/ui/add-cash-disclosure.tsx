...
import { Plus, X, Wallet, Check, CreditCard } from 'lucide-react';
        ...
        <AnimatePresence mode="popLayout" initial={false}>
          {!isOpen ? (
            <motion.div
              ...
              className="flex w-64 sm:w-80 items-center justify-between gap-4 sm:gap-10 border border-[#ECECEC] bg-white p-3 dark:border-white/5 dark:bg-[#1C1C1E] overflow-hidden"
            >
              <div className="flex items-center gap-2 sm:gap-3">
                <motion.div
                  layoutId="wallet-icon"
                  className="flex h-10 w-10 items-center justify-center rounded-xl border-[1.5px] border-[#ECECEC] bg-gradient-to-b from-[#F4F4F4] to-[#E2E3EA]/50 shadow-sm transition-colors sm:h-14 sm:w-14 dark:border-white/10 dark:from-[#2A2A2D] dark:to-[#1C1C1E]"
                >
                  <Wallet
            ...
            <motion.div
              ...
              className="flex w-64 sm:w-80 flex-col border border-[#ECECEC] bg-white py-3 dark:border-white/5 dark:bg-[#1C1C1E] overflow-hidden"
              style={{
                borderRadius: 24,
              }}
            >
              <motion.div layout>
                <div className="flex items-center justify-between gap-2 px-4">
                  <div className="flex items-center gap-2">
                    <motion.div
                      layoutId="wallet-icon"
                      className="flex h-10 w-10 items-center justify-center rounded-xl border-[1.5px] border-[#ECECEC] bg-gradient-to-b from-[#F4F4F4] to-[#E2E3EA]/50 shadow-sm sm:h-12 sm:w-12 dark:border-white/10 dark:from-[#2A2A2D] dark:to-[#1C1C1E]"
                    >
                      <Wallet
                      ...
                      return (
                        <div
                          ...
                          className={`flex cursor-pointer items-center justify-between rounded-xl border-[1.5px] p-3 transition-all sm:p-4 ${isSelected
                              ...
                              : 'border-[#ECECEC] bg-[#F6F5FA] hover:border-gray-300 dark:border-white/5 dark:bg-white/5 dark:hover:border-white/20'
                            }`}
                        >
                          <div className="flex items-center gap-2 sm:gap-3">
                            <div
                      ...
                      {isDone ? (
                        ...
                        >
                          <div className="flex items-center justify-center rounded-full bg-white p-1 dark:bg-black">
                            <Check
                              className="w-3 h-3 text-[#262629] dark:text-white"
                              strokeWidth={4}
                            />
                          </div>
