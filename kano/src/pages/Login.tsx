...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative px-4">
      ...
      <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-secondary/8 rounded-full blur-[100px]" />
      ...
      >
        ...
        <button onClick={handleGoogleLogin} className="btn-outline-glow w-full flex items-center justify-center gap-2 text-sm">
